...
//! | `OBJECT_STORE_ROOT` | `/tmp/personify-objects` | Root directory for the filesystem object store |
...
fn default_raw_config() -> RawConfig {
    RawConfig {
        ...
        object_store_root: PathBuf::from("/tmp/personify-objects"),
