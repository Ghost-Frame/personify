...
- Always run agent-forge: spec_task before new systems, log_hypothesis before recall failures, challenge_code before declaring done, session_diff before merge.
...
## Concrete Patterns -- Kleos Memory Stack
...
- Kleos: `kleos-cli store --tags "context:memory" --source "claude-code:memory"`
